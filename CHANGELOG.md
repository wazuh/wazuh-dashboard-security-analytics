...
- Change integration detail (summary with dates), integrations list shows Space before Rules, integration form add Supports alongside other optional fields, simpler Root Decoder label when editing a policy [#129](https://github.com/wazuh/wazuh-dashboard-security-analytics/pull/129)
