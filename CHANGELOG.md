...
- Added Integrations management feature [#40](https://github.com/wazuh/wazuh-dashboard-security-analytics/pull/40) [#48](https://github.com/wazuh/wazuh-dashboard-security-analytics/pull/48)
...
- Updated integration forms to use 'Title' label instead of 'Name' and added optional 'References' field [#62](https://github.com/wazuh/wazuh-dashboard-security-analytics/pull/62)
...
- Fixed empty category selector on create integrations form [#64](https://github.com/wazuh/wazuh-dashboard-security-analytics/pull/64)